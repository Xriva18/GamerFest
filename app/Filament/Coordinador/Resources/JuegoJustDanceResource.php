...
use App\Filament\Coordinador\Resources\JuegoJustDanceResource\Pages;
use App\Filament\Coordinador\Resources\JuegoJustDanceResource\RelationManagers;
...
class JuegoJustDanceResource extends Resource
{
    protected static ?string $model = BaseCoordinadorJuego::class;

    protected static ?string $navigationIcon = 'heroicon-o-puzzle-piece';

    protected static ?string $label = 'Just Dance';
    protected static ?string $pluralLabel = 'Just Dance';
    ...
    {
        return [
            'index' => Pages\ListJuegoJustDances::route('/'),
            'create' => Pages\CreateJuegoJustDance::route('/create'),
            'edit' => Pages\EditJuegoJustDance::route('/{record}/edit'),
        ];
    }
}

...
use App\Filament\Coordinador\Resources\JuegoValorantResource\Pages;
use App\Filament\Coordinador\Resources\JuegoValorantResource\RelationManagers;
...
class JuegoValorantResource extends Resource
{
    protected static ?string $model = BaseCoordinadorJuego::class;

    protected static ?string $navigationIcon = 'heroicon-o-puzzle-piece';

    protected static ?string $label = 'Valorant';
    protected static ?string $pluralLabel = 'Valorant';
    ...
    public static function getEloquentQuery(): \Illuminate\Database\Eloquent\Builder
    {
        ...
        return parent::getEloquentQuery()->where('id', 3);
    }
    ...
    {
        return [
            'index' => Pages\ListJuegoValorants::route('/'),
            'create' => Pages\CreateJuegoValorant::route('/create'),
            'edit' => Pages\EditJuegoValorant::route('/{record}/edit'),
        ];
    }
}
